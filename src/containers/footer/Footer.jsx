...
const Footer = () => (
  <div className="hp__footer section__padding" id="contactus">>

    <div className="hp__footer-heading">
      <h1 className="gradient__text">Do you want to step in to the future before others</h1>
    </div>

    <div className="hp__footer-btn">
      <p>Request Early Access</p>
    </div>

    <div className="hp__footer-links">

      <div className="hp__footer-links_logo">
        {/* <img src={gpt3Logo} alt="gpt3_logo" /> */}
        <img src={hpLogo} alt="hp_logo" />
        <p>Crechterwoord K12 182 DK Alknjkcb, <br /> All Rights Reserved</p>
      </div>

      {/* <div className="hp__footer-links_div">
        <h4>Links</h4>
        <p>Overons</p>
        <p>Social Media</p>
        <p>Counters</p>
    ...
    <div className="hp__footer-copyright">
